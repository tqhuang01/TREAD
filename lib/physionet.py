...
class PhysioNet(object):
    ...
    def __init__(self, root, download=False,
        ...
        if device == torch.device("cpu"):
            ...
            data_a = torch.load(os.path.join(self.processed_folder, self.set_a), weights_only=False)
            data_b = torch.load(os.path.join(self.processed_folder, self.set_b), weights_only=False)
            data_c = torch.load(os.path.join(self.processed_folder, self.set_c), weights_only=False)
